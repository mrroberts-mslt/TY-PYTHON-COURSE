...
counter = 1
# Condition checks if the counter variable is less than 5
while counter < 5:
  print("This code is inside the loop")
  #This code adds one to the value in the counter variable
  counter += 1
  print (str(counter))
...
while counter <= 12:
  ...
  total = num1 * counter
  print (str(counter) + " times " + str(num1) + " = " + str(total))
  counter +=1
